            ...
            <div class="table-responsive">
              <table class="table align-items-center table-flush">
                ...
                <tbody class="list">
                  <?php
                    require_once "../koneksi.php";
                    $sql = "SELECT t.*,ja.deskripsi, s.keterangan as status FROM `task` t INNER JOIN `jenis_ac` ja on t.jenis_ac INNER JOIN status s on t.status = s.status = ja.id WHERE t.`status` = 2 and `petugas` = '$uname'";
                  ...
                  <tr>
                    ...
                    <td><?php echo $tampil['jenis_layanan']; ?></td>
