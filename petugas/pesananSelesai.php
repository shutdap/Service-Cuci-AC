        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
              <h6 class="h2 text-white d-inline-block mb-0">Pesanan Selesai</h6>
        ...
        <div class="col">
          <div class="card">
            ...
            <div class="card-header border-0">
              <h3 class="mb-0">Pesanan Selesai</h3>
            </div>
            <!-- Light table -->
            <div class="table-responsive">
              <table class="table align-items-center table-flush">
                ...
                <tbody class="list">
                  <?php
                    require_once "../koneksi.php";
                    $sql = "SELECT DISTINCT t.*,ja.deskripsi, s.keterangan as status,l.keterangan as layanan,t.id as tasksid FROM `task` t INNER JOIN `jenis_ac` ja on t.jenis_ac = ja.jenis or t.jenis_ac = ja.id and t.jenis_layanan = ja.kategori INNER JOIN status s on t.status = s.status INNER JOIN layanan l on t.jenis_layanan = l.jenisLayanan WHERE t.`status` = 5  and `petugas` = '$uname'";
